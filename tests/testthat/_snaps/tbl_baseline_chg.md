...
# gather_ard() works on output table
    ...
    Output
      ...
      1 TRTA   Placebo      AVAL     Baseline       summary mean      Mean       141.   <fn>    <NULL>  <NULL> stat_1    
      2 TRTA   Placebo      AVAL     Baseline       summary sd        SD           1.46 <fn>    <NULL>  <NULL> stat_1    
      # i 618 more rows
      
      $add_overall
      # An ARD data frame: 229 x 10
      ...
      1 AVAL     Baseline       summary mean      Mean       140.   <fn>    <NULL>  <NULL> stat_0    
      2 AVAL     Baseline       summary sd        SD           2.78 <fn>    <NULL>  <NULL> stat_0    
      # i 227 more rows
