...
But for such a common table, the code is somewhat long, and we therefore created `crane::tbl_demographics()`.
...
As some of these steps are not the most straightforward, we created the `tbl_demographics()` wrapper.
